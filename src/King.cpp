...
*e o rei deve poder se mover até lá
*
*Hipóteses: Se o movimento do rei for possível, o método deve retornar um booleano true, 
...
*Interface implicita: Não há interface implícita
*
*Contrato na especificação: Se o movimento do rei for possível, o método deve retornar um booleano true, 
*caso contrário deve retornar um booleano false
*
*/
